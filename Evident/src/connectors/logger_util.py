...
class ConnectorLogger:
    ...
    def __init__(self, connector_id: str):
        ...
        # Resolve absolute path for logs directory (root/data)
        # __file__ is c:\PRODDEV\personal\cybersecurity-ai\Evident\evident\connectors\logger_util.py
        base_dir = Path(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) # Project root
        self.log_dir = base_dir / "data" / "livedata" / "debug_logs"
